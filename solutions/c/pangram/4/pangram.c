...
// A bit mask that's the result of bitwise-or'ing 0-25:
// int mask = 0; for (int i = 0; i < 26; i++) { mask |= (1 << i); }.
// It's a constant, we don't need to calculate it every time...
const int PANGRAM_MASK = 67108863;
...
bool is_pangram(const char *sentence) {
    ...
    return alphabet_mask == PANGRAM_MASK;
}
