...
attack_status_t can_attack(position_t queen_1, position_t queen_2) {
    if (positions_invalid(queen_1, queen_2)) return INVALID_POSITION;
    return attackable(queen_1, queen_2) ? CAN_ATTACK : CAN_NOT_ATTACK;
}

bool positions_invalid(position_t queen_1, position_t queen_2) {
    return is_out_of_bounds(queen_1) || is_out_of_bounds(queen_2) || is_collision(queen_1, queen_2);
}

bool attackable(position_t queen_1, position_t queen_2) {
    return same_row(queen_1, queen_2) || same_column(queen_1, queen_2) || same_diagonal(queen_1, queen_2);
}
